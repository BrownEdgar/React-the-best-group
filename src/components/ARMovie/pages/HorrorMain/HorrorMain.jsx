    ...
    <>
      {isOpen
        ? <Modal toggleModal={toggleModal} isOpen={isOpen}>
          <div className="HorrorModal">
            <h2>Terrible Information</h2>
            <p>{currentInfo}</p>
            <div className="HorrorModal__buttons">
      ...
      <div className="HorrorMain">
        {
          witches.length > 0 ?
            witches.map(witch => {
              return (
                <div className="HorrorMain__witch" key={witch.id}>
                  <img src={witch.img} />
                  <div className="HorrorMain__content">
                    <h2>{witch.name}</h2>
                    <img onClick={() => {
                      toggleModal();
            ...
            : <div className="HorrorMain__Micky">
