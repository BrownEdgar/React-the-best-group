...
import './ComicsActors.scss'
import ROUTES from '../routes'


export default function ComicsActors() {
  ...
  return (
    <div className='ComicsActors'>
      <h2>Best Marvel Actors</h2>
      {
        comicsActors.map(actor => {
          return <Link key={actor.id} className="ComicsActors__card" to={`${ROUTES.COMICS}/${actor.name}`}>
